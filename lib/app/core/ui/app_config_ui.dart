...
class AppConfigUi {
  ...
  static const MaterialColor _primarySwatch = MaterialColor(0XFF0066B0, {
    50: Color(0XFF005c9e), // Começa no 10%
  ...
  static final ThemeData theme = ThemeData(
    primarySwatch: _primarySwatch, // A cor principal da aplicação
    primaryColor: const Color(0XFF0066B0),
    primaryColorLight: const Color(0XFF219FFF),
    inputDecorationTheme: const InputDecorationTheme(
      // Configurando todos os inputs
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      // Configurando todos os elevatedButton
